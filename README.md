...
|-----------------------|----------|----------|----------|----------|
| Facturación total     | $1.212M  | $1.176M  | $1.157M  | $1.094M  |
| % del negocio         | 26.1%    | 25.4%    | 24.9%    | 23.6%    |
...
git clone https://github.com/Ghisbe/Desafio_alura_store.git

# 2. Entrar en la carpeta del proyecto
cd Desafio_alura_store
